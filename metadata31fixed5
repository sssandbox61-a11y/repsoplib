                    ...
                    function createMetadata(buffer, referencedAssemblies) {
                        return __awaiter(this, void 0, void 0, function* () {
                            ...
                            while (i < len) {
                                ...
                                assemblies.push(imageName);
                                if (referencedAssemblies === null || referencedAssemblies === void 0 ? void 0 : referencedAssemblies.includes(imageName))
                                    referencedImageDefs.push(imageDef);
                                i++;
                            }
                            //
                            var _logger__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../logger */ "./src/logger/index.ts");
                            const speciallogger = new _logger__WEBPACK_IMPORTED_MODULE_0__.Logger("Assembly");
                            speciallogger.info("Assemblies:", assemblies);
                            //
...
/* harmony export */   Logger: () => (/* binding */ Logger)
                    ...
                    class Logger {
                        ...
                        log(level, ...args) {
                            if (!debugMode) return;
                            if (typeof level === "string") { args.unshift(level); level = LogLevel.MESSAGE; }
                            if (this.shouldLog(level) && args.length > 0) {
                                ...
                                console.debug(logPrefix + message, logStyles, messageStyles, "color: default;", ...args);
                            }
                        }
                        shouldLog(level) {
...
/* harmony import */ var _mod__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../mod */ "./src/mod.ts");
                    ...
                    function preload() {
                        logger.debug("UnityWebModkit v%s - %s", _mod__WEBPACK_IMPORTED_MODULE_2__.version, window.location.hostname);
                        // @ts-ignore Set by webpack at bundle time
                        logger.debug("Build hash: %s", __webpack_require__.h());
                        return loadWebData();
                    }
                            ...
                            return new Promise((resolve) => {
                                ...
                                window.fetch = function (url, options) {
                                    return __awaiter(this, arguments, void 0, function* () {
                                        if (url.includes(".data") && (!options || !options.method || options.method.toLowerCase() === "get")) {
                                            logger.debug("Injector: Found request!");
                                            options = options || {};
                                            options.headers = new Headers(options.headers || {});
                                            options.headers.delete("If-Modified-Since");
                                            options.headers.delete("If-None-Match");

                                            const response = yield originalFetch.call(this, url, options); //yield originalFetch.apply(this, arguments);
                                            if (response.status === 200) {
                                                window.fetch = originalFetch;
                                                logger.debug("Injector: Got valid response")
                                                resolve(parseWebData(yield response.clone().arrayBuffer()));
                                                logger.debug("Injector: Successfully injected!")
                                                return response;
                                            }
                                        }
                                        //logger.debug("5: Not matched %s", url);
                    ...
                    class Runtime {
                        ...
                        initialize() {
                            return __awaiter(this, void 0, void 0, function* () {
                                ...
                                webData.unityVersion
                                    ? this.logger.debug("Running under Unity %s", webData.unityVersion)
                        ...
                        loadGlobalMetadata(webData) {
                            return __awaiter(this, void 0, void 0, function* () {
                                ...
                                if (debugMode) {
                                    const blob = new Blob([metadataNode.data], { type: "application/octet-stream" });
                                ...
                                indexedDB.databases().then((databases) => __awaiter(this, void 0, void 0, function* () {
                                    ...
                                    request.onsuccess = () => {
                                        ...
                                        metadataRequest.onsuccess = () => __awaiter(this, void 0, void 0, function* () {
                                            ...
                                            this.logger.debug(globalMetadata);
                        ...
                        resolveIl2CppFunctions(importObject) {
                            ...
                            this.logger.debug("resolved funcs i hope");
                        }
                        exportIl2CppFunctions(wail) {
                            ...
                            this.logger.debug("Exported %d Il2Cpp functions", Object.keys(this.resolvedIl2CppFunctions).length);
                        }
                    ...
                    class BinaryReader {
                        ...
                        readNullTerminatedUTF8String() {
                            ...
                            if (this._offset >= this._view.byteLength) {
                                throw new Error(`Offset ${this._offset} out of range for buffer of length ${this._view.byteLength}`);
                            }
                    ...
                    class WailParser extends BufferReader {
                        ...
                        editGlobalEntry(globalIndex, options) {
                            ...
                            if (typeof globalIndex === "number") {
                                console.debug(
                                    "[WARNING] Using raw indexes in editGlobalEntry() can have unpredictable " +
                        ...
                        addCodeEntry(funcIndex, options) {
                            ...
                            if (typeof funcIndex === "number") {
                                console.debug(
                                    "[WARNING] Using raw indexes in addCodeEntry() can have unpredictable " +
                        ...
                        editCodeEntry(funcIndex, options) {
                            ...
                            if (typeof funcIndex === "number") {
                                console.debug(
                                    "[WARNING] Using raw indexes in editCodeEntry() can have unpredictable " +
                                    "results. Consider using getFunctionIndex() instead",
                                );
                            } else if (!(funcIndex instanceof WailVariable)) {
                                throw new Error("Invalid funcIndex in addCodeEntry()");
                        ...
                        _parseCodeSection() {
                            ...
                            for (let i = 0; i < oldCount; i++) {
                                if (i % 5000 == 0 && i != 0) {
                                    if (debugMode) console.log("Parsing function " + i + " of " + oldCount);
